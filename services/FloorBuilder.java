...
package com.ramya.services;

import com.ramya.Mergesort;
import com.ramya.Queue;
...
public class FloorBuilder {
	...
	public static Queue[] build(int[] floorSizeArr) {
		...
		/*System.out.println("The sorted out floor sizes with day of arrival: ");
		for (int i = 0; i < numDays; i++) 
			System.out.println(floorPlan[i][0] + " | " + floorPlan[i][1]);*/
